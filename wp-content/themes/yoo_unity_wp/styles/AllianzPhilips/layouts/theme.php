		...
		<?php endif; ?>
 				...
 				<?php if ($this['widgets']->count('logo + headerbar + search')) : ?>
					...
					<div class="tm-headerbar uk-clearfix uk-hidden-small uk-vertical-align">
						...
						<div class=" uk-width-2-3 uk-vertical-align-middle">
							<div class="uk-grid">
								<div class="uk-width-1-2">
									<div class="uk-hidden-small" style="margin-left: 20px;">
...
var breakpoint_medium = 760; //768
var breakpoint_large = 960;

jQuery(window).on('resize load', function() {
	if (jQuery(window).width() >= breakpoint_medium) {
		// jQuery(".uk-navbar").css({"background":"#233c7d"});
		jQuery(".uk-navbar").css({"background":"#2598d6"});
	} else {
		// jQuery(".uk-navbar").css({"background":"#fafafa"});
		jQuery(".uk-navbar").css({"background":"#f3f3f3"});
	}


	if (jQuery(window).width() >= breakpoint_large) {
	   	jQuery(".uk-navbar-nav > li > a").css({"font-size":"17px"});
	} else {
		jQuery(".uk-navbar-nav > li > a").css({"font-size":"14px"});
	}
